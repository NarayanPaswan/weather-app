class BooksCategoryModel {
  ...
  BooksCategoryModel({this.kind, this.totalItems, this.items});

  BooksCategoryModel.fromJson(Map<String, dynamic> json) {
    kind = json['kind'];
...
class SaleInfo {
  ...
  SaleInfo.fromJson(Map<String, dynamic> json) {
    ...
    retailPrice = json['retailPrice'] != null
        ? PriceList.fromJson(json['retailPrice'])
        : null;
...
class PriceList {
  ...
  PriceList({this.amountInMicros, this.currencyCode});
